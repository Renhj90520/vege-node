...
exports.getFavorites = function(req, res) {
  ...
  models.favorites
    .findAll({ where: { openid: openid } })
    .then(function(favs) {
      var ids = favs.map(function(f) {
        return f.ProductId;
      });
      ...
      models.products
        .findAll({
          where: { Id: ids },
          include: [{ model: models.pictures, as: "Pictures", require: false }]
        })
        .then(function(products) {
          res.json(buildResult("获取成功", products, 1));
        })
        .caught(function(err) {
...
exports.getFavorite = function(req, res) {
  ...
  models.favorites
    .findAll({ where: { openid: openid, productid: productid } })
    .then(function(favs) {
